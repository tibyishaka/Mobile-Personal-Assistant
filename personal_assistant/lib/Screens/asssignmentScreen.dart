...
class _AssignmentManagementScreenState
  ...
  void _editAssignment(Assignment assignment) {
    ...
    _selectedCourse = assignment.courseName;
  ...
  void _showAssignmentDialog() {
    // Get class names from schedule provider
    final scheduleProvider = Provider.of<ScheduleProvider>(
      context,
      listen: false,
    );
    final classNames = scheduleProvider.getClassNames();
          ...
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: classNames.isEmpty ? null : _addOrUpdateAssignment,

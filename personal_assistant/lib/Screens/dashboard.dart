      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text('Quiz2 - 11:00AM', style: TextStyle(fontSize: 18)),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text('formative - 12:00PM', style: TextStyle(fontSize: 18)),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              children: [
                ...
                if (low) Text(' (Low)', style: TextStyle(color: Colors.red)),
              ],
            ),
          ),
          const Padding(
